...
{    !insideCategory &&        <button onClick={()=>deleteVideo(displayData?.id)} className='btn'><i className='fa-solid fa-trash text-danger'></i></button>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          <iframe width="100%" height="400" src={`${displayData?.youtubeLink}?autoplay=1`} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>

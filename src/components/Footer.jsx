...
function Footer() {
  return (
    <div style={{height:'300px'}} className='container mt-5 w-100'>
       ...
       <p style={{textAlign:"justify"}}>designed and built with all the love in the world by the bootstrap tram with the help of our contributors</p>
       <span>code licensed MIT ,docs cc bt 3.0</span>
       ...
       <p className='text-center mt-5'>Copyright &copy;2023 media player.build with react</p>
    </div>
  )
}
